...
class ApiClient
{
    ...
    private function sendRequest($api_method, $http_method = 'GET', $data = null)
    {
        ...
        // overdie the api url based on settings for sandbox
     ...
     * @return string The raw API response
     */
    public function deactivateMember($member_profile)
    {
      return $this->sendRequest('/deactivate_member.json', 'POST', $member_profile);
    }
     ...
     * @return string The raw API response
     */
    public function reactivateMmber($member_profile)
    {
      return $this->sendRequest('/reactivate_member.json', 'POST', $member_profile);
    }
